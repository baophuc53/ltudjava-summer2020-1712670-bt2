...
public class ShowTkb extends JFrame {
	...
	public ShowTkb() {
		...
		JLabel lblNewLabel = new JLabel("Xem thời khóa biểu theo lớp");
		...
		btnNewButton.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				...
				int stt = 1;
				List<Tkb> tkb= TkbDAO.layTkbTheoLop(lop);
				for	(Tkb i: tkb) {
					String[] temp = {String.valueOf(stt), i.getMaMon(), i.getTenMon(),  i.getPhongHoc()};
					model.addRow(temp);
					stt++;
				}
			}				
